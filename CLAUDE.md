...
**Always read `ranger/SPO_REWARD_ANALYSIS_CHART.html` at the start of each session** for all information about the interactive chart.
**Always read `ranger/claude_queries/saturation_cap_fix.md` at the start of each session** to understand what repair was man to `ranger/SPO_REWARD_ANALYSIS_CHART.html` that we may want to apply to the Epoch Reporting System.
